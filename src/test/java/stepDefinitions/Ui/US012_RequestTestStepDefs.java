...
public class US012_RequestTestStepDefs {

    US012_LoginPage loginPage = new US012_LoginPage();
    US012_RequestTestPage requestTestPage = new US012_RequestTestPage();
    US012_AppointmentPage myPagesAppointmentPage = new US012_AppointmentPage();
    ...
    public void doktor_gecerli_bir_kullanici_adi_sign_in_sayfasina_girer(String username) {
        DriverX.waitAndSendText(loginPage.usernameBox, username);
    }
    ...
    public void doktor_gecerli_bir_kullanici_parolasi_sign_in_sayfasina_girer(String password) {
        DriverX.waitAndSendText(loginPage.passwordBox, password);
    }
    @When("doktor sign in butonuna tiklar")
    public void doktor_sign_in_butonuna_tiklar() {
        DriverX.waitAndClick(loginPage.signInButton);
    }
    ...
    public void doktor_my_pages_sekmesine_tiklar() {
        DriverX.waitForVisibility(myPagesAppointmentPage.myPages, 10);
    ...
    public void doktor_edit_buttonuna_tiklar() {
        DriverX.waitForVisibility(myPagesAppointmentPage.editButton, 10);
    ...
    public void doktor_bir_test_iste_button_a_cift_tiklar() throws InterruptedException {
        DriverX.doubleClick(requestTestPage.requestTestButton);
        Thread.sleep(2000);
    }
